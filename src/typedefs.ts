...
// ): { [key: string]: UnresolvedRefDetails | undefined };
...
//  *          resource
//  */
// export function findRefsAt(
//   location: string,
//   options?: JsonRefsOptions
// ): Promise<RetrievedRefsResults>;
...
export interface JsonRefsOptions {
     ...
     */
    filter?: string | string[] | RefDetailsFilter;
    /**
...
export interface JsonRefsOptionsValidated extends Omit<JsonRefsOptions, 'subDocPath' | 'filter'> {
    /**
     * array of path segments to the sub document
     * location to search from
     */
    subDocPath: string[];

    filter: RefDetailsFilter;
}
 ...
 */
export interface RetrievedRefsResults extends ResolvedRefsResults {
    /**
